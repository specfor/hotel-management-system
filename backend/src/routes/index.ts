...
apiRouter.put(
  "/room-type/:branchId/:roomTypeName",
...
apiRouter.get(
  "/discount/branch/:branchId",
  discountController.getDiscountsByBranch
);
...
apiRouter.get(
  "/service/:serviceID",
  serviceController.getChargeableServiceByID
);
apiRouter.put("/service/:serviceID", serviceController.updateChargeableService);
apiRouter.delete(
  "/service/:serviceID",
  serviceController.deleteChargeableService
);

// endpoints for booking
apiRouter.get(
  "/booking/guest/:guestID",
  bookingController.getBookingsByGuestID
);
...
apiRouter.get(
  "/service-usage/:usageID",
  serviceUsageController.getServiceUsageByID
);
apiRouter.put(
  "/service-usage/:usageID",
  serviceUsageController.updateServiceUsage
);
apiRouter.delete(
  "/service-usage/:usageID",
  serviceUsageController.deleteServiceUsage
);
